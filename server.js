...
const db = mysql.createConnection({
  host: 'bropmdvxfe8qztmefz6q-mysql.services.clever-cloud.com',
  user: 'ucjblme5mhbuos4m',
  password: 'uHm5HQeY1s4XjkBNmFXr',
  database: 'bropmdvxfe8qztmefz6q',
  port: '3306',
});
  ...
  db.query(
    ...
    (err, results) => {
      ...
      if (results.length > 0) {
        ...
        db.query(
          'INSERT INTO budgets (category, month, year, userid, allocated, used) VALUES (UPPER(?), ?, ?, ?, 0, ?)',
...
app.listen(PORT, '155.138.211.107', () => {
  console.log(`Server is running at http://155.138.211.107:${PORT}`);
});